...
exportDirectory = '/Users/Julian/Documents/_Projects/MDV-Lakes-Thesis/albedo-model/data/gee-exports/';
...
albedo.TAR.swirBSAsmooth=movmean(albedo.TAR.swirBSA(),windowSize,1,'omitnan');
albedo.TAR.swirWSAsmooth=movmean(albedo.TAR.swirWSA(),windowSize,1,'omitnan');
albedo.TAR.swirsmooth=movmean(albedo.TAR.swir(),windowSize,1,'omitnan');
albedo.TAR.visBSAsmooth=movmean(albedo.TAR.visBSA(),windowSize,1,'omitnan');
albedo.TAR.snowsmooth=movmean(albedo.TAR.snow(),windowSize,1,'omitnan');

albedo.CAA.swirBSAsmooth=movmean(albedo.CAA.swirBSA(),windowSize,1,'omitnan');
albedo.CAA.swirWSAsmooth=movmean(albedo.CAA.swirWSA(),windowSize,1,'omitnan');
albedo.CAA.swirsmooth=movmean(albedo.CAA.swir(),windowSize,1,'omitnan');
albedo.CAA.visBSAsmooth=movmean(albedo.CAA.visBSA(),windowSize,1,'omitnan');
albedo.CAA.snowsmooth=movmean(albedo.CAA.snow(),windowSize,1,'omitnan');

albedo.HOD.swirBSAsmooth=movmean(albedo.HOD.swirBSA(),windowSize,1,'omitnan');
albedo.HOD.swirWSAsmooth=movmean(albedo.HOD.swirWSA(),windowSize,1,'omitnan');
albedo.HOD.swirsmooth=movmean(albedo.HOD.swir(),windowSize,1,'omitnan');
albedo.HOD.visBSAsmooth=movmean(albedo.HOD.visBSA(),windowSize,1,'omitnan');
albedo.HOD.snowsmooth=movmean(albedo.HOD.snow(),windowSize,1,'omitnan');

albedo.COH.swirBSAsmooth=movmean(albedo.COH.swirBSA(),windowSize,1,'omitnan');
albedo.COH.swirWSAsmooth=movmean(albedo.COH.swirWSA(),windowSize,1,'omitnan');
albedo.COH.swirsmooth=movmean(albedo.COH.swir(),windowSize,1,'omitnan');
albedo.COH.visBSAsmooth=movmean(albedo.COH.visBSA(),windowSize,1,'omitnan');
albedo.COH.snowsmooth=movmean(albedo.COH.snow(),windowSize,1,'omitnan');

albedo.glaciers.swirBSAsmooth=movmean(albedo.glaciers.swirBSA(),windowSize,1,'omitnan');
albedo.glaciers.swirWSAsmooth=movmean(albedo.glaciers.swirWSA(),windowSize,1,'omitnan');
albedo.glaciers.swirsmooth=movmean(albedo.glaciers.swir(),windowSize,1,'omitnan');
