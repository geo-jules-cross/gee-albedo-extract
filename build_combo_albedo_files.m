...
% Initialize array
missing = zeros(length(albedo.CAA.date),9);
...
%                         data(d,4)=albedo.CAA.measured(d)*0.93;
    ...
    switch g
        case 1
            ...
            dlmwrite([dataDir '/model-inputs/' 'combo_albedo.TAR'], albedo.model.TAR, '\t');
        case 2
            albedo.model.RHO = data;
            dlmwrite([dataDir '/model-inputs/' 'combo_albedo.RHO'], albedo.model.RHO, '\t');
        case 3
            albedo.model.MTN = data;
            dlmwrite([dataDir '/model-inputs/' 'combo_albedo.MTN'], albedo.model.MTN, '\t');
        case 4
            albedo.model.LCX = data;
            dlmwrite([dataDir '/model-inputs/' 'combo_albedo.LCX'], albedo.model.LCX, '\t');
        case 5
            albedo.model.HUS = data;
            dlmwrite([dataDir '/model-inputs/' 'combo_albedo.HUS'], albedo.model.HUS, '\t');
        case 6
            albedo.model.SUS = data;
            dlmwrite([dataDir '/model-inputs/' 'combo_albedo.SUS'], albedo.model.SUS, '\t');
        case 7
            albedo.model.CAA = data;
            dlmwrite([dataDir '/model-inputs/' 'combo_albedo.CAA'], albedo.model.CAA, '\t');
        case 8
            albedo.model.COH = data;
            dlmwrite([dataDir '/model-inputs/' 'combo_albedo.COH'], albedo.model.COH, '\t');
        case 9
            albedo.model.HOD = data;
            dlmwrite([dataDir '/model-inputs/' 'combo_albedo.HOD'], albedo.model.HOD, '\t');
    end
end