...
strt=find(albedo.old.TAR.date==datenum([2000 07 01]));
fnsh=find(albedo.old.TAR.date==datenum([2015 06 30]));
...
xData1 = {albedo.old.TAR.visBSA(strt:fnsh), albedo.old.TAR.swirWSA(strt:fnsh), albedo.old.TAR.swirBSA(strt:fnsh), albedo.old.TAR.swir(strt:fnsh)}; % Removed albedo.old.TAR.snow(strt:fnsh)
xData = {albedo.old.TAR.visBSAsmooth(strt:fnsh), albedo.old.TAR.swirWSAsmooth(strt:fnsh), albedo.old.TAR.swirBSAsmooth(strt:fnsh), albedo.old.TAR.swirsmooth(strt:fnsh)};
...
for s=1:4
    ...
    % Plot albedo data
    scatter(xData1{s}, albedo.old.TAR.measured(strt:fnsh), 25,[0.5 0.5 0.5],'filled');
    scatter(xData{s}, albedo.old.TAR.measured(strt:fnsh), 10,'k','filled');
    ...
    RMSPE(s) = sqrt(MSPE);
    % Display
    str = {['RMS Error: ', num2str(RMSE(s), '%4.3f')], ['RMS Error: ', num2str(RMSPE(s)*100, '%4.1f'), '%']};
...
% Albedo 1:1 Scatterplot
xData1 = {albedo.old.CAA.visBSA(strt:fnsh), albedo.old.CAA.swirWSA(strt:fnsh), albedo.old.CAA.swirBSA(strt:fnsh), albedo.old.CAA.swir(strt:fnsh)};
xData = {albedo.old.CAA.visBSAsmooth(strt:fnsh), albedo.old.CAA.swirWSAsmooth(strt:fnsh), albedo.old.CAA.swirBSAsmooth(strt:fnsh), albedo.old.CAA.swirsmooth(strt:fnsh)};
varName = {'MCD43A3 \alpha_{vis}', 'MCD43A3 WSA \alpha_{sw}', 'MCD43A3 BSA \alpha_{sw}' 'MCD43A3 \alpha_{sw}'};
...
for s=1:4
    ...
    % Plot albedo data
    scatter(xData1{s}, albedo.old.CAA.measured(strt:fnsh), 25,[0.5 0.5 0.5],'filled');
    scatter(xData{s}, albedo.old.CAA.measured(strt:fnsh), 10,'k','filled');
...
%% All Years HODM v. MODIS Plots

strt=find(albedo.old.HOD.date==datenum([2000 11 1]));
fnsh=find(albedo.old.HOD.date==datenum([2015 2 28]));
...
% Albedo 1:1 Scatterplot
xData1 = {albedo.old.HOD.visBSA(strt:fnsh), albedo.old.HOD.swirWSA(strt:fnsh), albedo.old.HOD.swirBSA(strt:fnsh), albedo.old.HOD.swir(strt:fnsh)};
xData = {albedo.old.HOD.visBSAsmooth(strt:fnsh), albedo.old.HOD.swirWSAsmooth(strt:fnsh), albedo.old.HOD.swirBSAsmooth(strt:fnsh), albedo.old.HOD.swirsmooth(strt:fnsh)};
varName = {'MCD43A3 \alpha_{vis}', 'MCD43A3 WSA \alpha_{sw}', 'MCD43A3 BSA \alpha_{sw}' 'MCD43A3 \alpha_{sw}'};
...
for s=1:4
    ...
    % Plot albedo data
    scatter(xData1{s}, albedo.old.HOD.measured(strt:fnsh), 25,[0.5 0.5 0.5],'filled');
    scatter(xData{s}, albedo.old.HOD.measured(strt:fnsh), 10,'k','filled');
...
%% All Year COHM v. MODIS Plots

strt=find(albedo.old.COH.date==datenum([2000 11 1]));
fnsh=find(albedo.old.COH.date==datenum([2015 2 28]));
...
xData1 = {albedo.old.COH.visBSA(strt:fnsh),albedo.old.COH.swirWSA(strt:fnsh), albedo.old.COH.swirBSA(strt:fnsh), albedo.old.COH.swir(strt:fnsh)};
xData = {albedo.old.COH.visBSAsmooth(strt:fnsh), albedo.old.COH.swirWSAsmooth(strt:fnsh), albedo.old.COH.swirBSAsmooth(strt:fnsh), albedo.old.COH.swirsmooth(strt:fnsh)};
varName = {'MCD43A3 \alpha_{vis}', 'MCD43A3 WSA \alpha_{sw}', 'MCD43A3 BSA \alpha_{sw}' 'MCD43A3 \alpha_{sw}'};
...
for s=1:4
    ...
    % Plot albedo data
    scatter(xData1{s}, albedo.old.COH.measured(strt:fnsh), 25,[0.5 0.5 0.5],'filled');
    scatter(xData{s}, albedo.old.COH.measured(strt:fnsh), 10,'k','filled');
